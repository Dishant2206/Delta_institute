...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col px-0">
                <img class="clg img-fluid" src="../image/1500290036php057LS1.jpeg" alt="clg_image" style="height:500px; width:2000px;">
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <img src="../image/67---16-06-2021-03-38-27.png" class="img-fluid" style="height:500px; width:1300px;"><br>
