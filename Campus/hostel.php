...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col px-0">
                <img class="clg img-fluid" src="../image/download.jpg" alt="clg_image" style="height:500px; width:2000px;"> 
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <center>
                    <img src="../image/hostel_management3.jpg" class="img-fluid" width="450px">
                </center>
            </div>
            <div class="col-md-6">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <ul type="none">
                    <li> <i class="fa-sharp fa-solid fa-shield"></i>&nbsp; 24×7 Securities </li>
