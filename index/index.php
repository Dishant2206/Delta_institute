...
<style>
    ...
    .slide-1 {
        background-image: url("../image/marwadi-university--10188096-55310a5f.jpg");
    }
    ...
    .slide-4 {
        background-image: url("../image/Slide_8.jpg");
    }
    ...
    .slide-7 {
        background-image: url("../image/1627891308_R56XZ0_Ravinder_Jadeja.jpg");
    }
    ...
    <div class="container">
        <div class="row">
            <div class="col-6 p-4 mt-4">
                <img class="mt-4 p-4" src="../image/download (3).jpg"style="height:400px; width:500px;">
            </div>
            <div class="col-6">
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class=" col-md-4">
                    <div class="card" style="width:400px">
                        <img class="card-img-top" src="../image/1160---12-09-2022-02-20-36.jpg" alt="Card image" style="width:100%">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card" style="width:400px">
                        <img class="card-img-top" src="../image/1156---03-09-2022-08-09-01.jpeg" alt="Card image" style="width:100%">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card" style="width:400px">
                        <img class="card-img-top" src="../image/1155---31-08-2022-12-26-00.jpg" alt="Card image" style="width:100%">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card" style="width:400px">
                        <img class="card-img-top" src="../image/1157---03-09-2022-08-49-15.jpeg" alt="Card image" style="width:100%">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card" style="width:400px">
                        <img class="card-img-top" src="../image/1154---27-08-2022-08-12-25.jpg" alt="Card image" style="width:100%">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card" style="width:400px">
                        <img class="card-img-top" src="../image/1147---21-07-2022-09-25-23.jpeg" alt="Card image" style="width:100%">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card" style="width:400px">
                        <img class="card-img-top" src="../image/1146---06-07-2022-11-50-27.jpeg" alt="Card image" style="width:100%">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card" style="width:400px">
                        <img class="card-img-top" src="../image/1144---04-07-2022-12-26-34.jpg" alt="Card image" style="width:100%">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card" style="width:400px">
                        <img class="card-img-top" src="../image/1152---22-08-2022-09-44-22.jpg" alt="Card image" style="width:100%">
                        <div class="card-body">
